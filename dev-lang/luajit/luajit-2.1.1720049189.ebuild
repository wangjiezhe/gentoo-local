...
EAPI=8
GIT_COMMIT=04dca7911ea255f37be799c18d74c305b921c1a6
...
IUSE="amalg lua52compat static-libs"
...
src_compile() {
	tc-export_build_env
	_emake XCFLAGS="$(usex lua52compat "-DLUAJIT_ENABLE_LUA52COMPAT" "")" $(usex amalg "amalg" "")
}
