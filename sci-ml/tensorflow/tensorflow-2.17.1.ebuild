...
bazel_external_uris="
	...
	https://github.com/google/XNNPACK/archive/bfea23551ac47c9d71b82120b299ff6173fc9097.zip -> XNNPACK-bfea23551ac47c9d71b82120b299ff6173fc9097.zip
	...
	https://github.com/llvm/llvm-project/archive/ae8627809076390dbab04e01f3bf9d384c9e124e.tar.gz -> llvm-project-ae8627809076390dbab04e01f3bf9d384c9e124e.tar.gz
	...
	https://github.com/oneapi-src/oneDNN/archive/refs/tags/v3.4.2.tar.gz -> oneDNN-v3.4.2.tar.gz
	https://github.com/openxla/stablehlo/archive/82bfdd489013e9aa85a0b5a5c346c850bb4672af.zip -> openxla-stablehlo-82bfdd489013e9aa85a0b5a5c346c850bb4672af.zip
	https://github.com/openxla/triton/archive/cl638583630.tar.gz -> openxla-triton-cl638583630.tar.gz
	...
	https://github.com/pytorch/cpuinfo/archive/ef634603954d88d2643d5809011288b890ac126e.zip -> pytorch-cpuinfo-ef634603954d88d2643d5809011288b890ac126e.zip
	https://github.com/tensorflow/runtime/archive/4662f7552dc2e420ee20361c077b7aeb334a1087.tar.gz -> tensorflow-runtime-4662f7552dc2e420ee20361c077b7aeb334a1087.tar.gz
	...
	https://gitlab.com/libeigen/eigen/-/archive/c1d637433e3b3f9012b226c2c9125c494b470ae6/eigen-c1d637433e3b3f9012b226c2c9125c494b470ae6.tar.gz
	...
	cuda? (
		https://github.com/NVIDIA/cudnn-frontend/archive/refs/tags/v1.3.0.zip -> cudnn-frontend-v1.3.0.zip
		https://github.com/NVlabs/cub/archive/1.9.9.zip -> cub-1.9.9.zip
		https://github.com/nvidia/nccl/archive/v2.19.3-1.tar.gz -> nvidia-nccl-v2.19.3-1.tar.gz
...
PATCHES=(
	"${FILESDIR}/${PN}-2.17.0-0001-WORKSPACE-add-rules-docker-http_archive-bazel-toolch.patch"
	"${FILESDIR}/${PN}-2.17.0-0002-systemlib-Latest-absl-LTS-has-split-cord-libs.patch"
	"${FILESDIR}/${PN}-2.17.0-0003-mkl_dnn-Must-link-against-libm-for-round-and-log2.patch"
	"${FILESDIR}/${PN}-2.17.0-0004-tensorflow_cc-Add-systemlib-nsync-linkopts.patch"
	"${FILESDIR}/${PN}-2.17.0-0005-systemlib-Updates-for-Abseil-20220623-LTS.patch"
	"${FILESDIR}/${PN}-2.17.0-0006-systemlib-Update-targets-for-absl_py.patch"
	"${FILESDIR}/${PN}-2.17.0-0007-systemlib-Add-well_known_types_py_pb2-target.patch"
	"${FILESDIR}/${PN}-2.17.0-0008-Relax-setup.py-version-requirements.patch"
	"${FILESDIR}/${PN}-2.17.0-0009-systemlib-update-targets-for-absl.patch"
	"${FILESDIR}/${PN}-2.17.0-0010-systemlib-fix-missing-osx-in-pybind11.patch"
	"${FILESDIR}/${PN}-2.17.0-0011-systemlib-fix-missing-LICENSE-in-flatbuffers.patch"
	"${FILESDIR}/${PN}-2.17.0-0012-systemlib-Add-missing-targets-for-absl.patch"
	"${FILESDIR}/${PN}-2.17.0-0013-installation-remove-create_local_config_python.patch"
	"${FILESDIR}/${PN}-2.17.0-0014-Revert-Use-hermetic-Python-in-TSL-and-XLA.patch"
	"${FILESDIR}/${PN}-2.17.0-0015-build-use-non-hermetic-python.patch"
	"${FILESDIR}/${PN}-2.17.0-0016-build-hardcode-wheel-name.patch"
)
