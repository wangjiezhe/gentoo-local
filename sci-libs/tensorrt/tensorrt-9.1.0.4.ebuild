...
EXTEND_VER="${BASE_VER}.post12.dev4"
GRAPHSURGEON_VER="0.4.0"
...
src_install() {
	...
	do_install() {
		...
		distutils_wheel_install "${ED}" "${S}/onnx_graphsurgeon/onnx_graphsurgeon-${GRAPHSURGEON_VER}-py2.py3-none-any.whl"
		python_optimize
	}
