...
PATCHES=(
	...
	"${FILESDIR}"/${P}-llhttp.patch
	"${FILESDIR}"/${PN}-16.20.2-build-avoid-usage-of-pipes-library.patch
	"${FILESDIR}"/${P}-build-fix-build-with-Python-3.12.patch
	"${FILESDIR}"/${P}-fix-ValueError-invalid-mode-rU.patch
)
